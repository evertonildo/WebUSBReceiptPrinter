...
class n extends i {
  ...
  async #a(e) {
      ...
      (this.#i = t.find((e) =>
        e.filters.some((e) =>
          e.vendorId && e.productId
            ? e.vendorId == this.#t.vendorId && e.productId == this.#t.productId
    ...
    (this.#n.output = i.alternate.endpoints.find((e) => "out" == e.direction)),
      (this.#n.input = i.alternate.endpoints.find((e) => "in" == e.direction)),
      await this.#t.reset(),
